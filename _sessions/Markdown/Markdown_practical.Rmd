  ...
  <tr style='border:none'>
    <td style='display:block;width:100%;text-align:left;vertical-align:bottom;padding:0;margin:0;border:none' nowrap>
      ...
      <a href='https://therbootcamp.github.io'>
        <font style='font-style:normal'>Data Analytics 4 PB</font>
      </a>
    </td>
...
1. Öffne dein `DataAnalytics4PB` R Projekt, dass ihr von Github gecloned habt. Es sollte die Ordner `1_Data`, `2_Assets`, und `3_Markdown` enthalten. 
...
5. Lade die Pakete `tidyverse`, `lubridate`, `knitr`, `kableExtra` und `sjPlot` im `setup` Chunk. Ggf. musst du die pakete erst installieren.
